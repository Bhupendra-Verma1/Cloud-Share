...
const HeroSection = ({ openSignIn, openSignUp }) => {
    return (
        <div className="landing-page-content relative">
            <div className="absolute inset-0 bg-linear-to-r from-purple-50 to-indigo-50 opacity-80 z-0 pointer-events-none">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
                    <div className="text-center">
                        ...
                        <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                            <div className="space-y-0 inline-grid grid-cols-2 gap-5 mx-auto">
                                <button
                                    onClick={() => openSignUp()}
                                ...
                                <button
                                    onClick={() => openSignIn()}
                                    className="flex items-center justify-center px-6 py-3 border border-gray-300 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 transition-all duration-300 shadow-md hover:shadow-lg"
                                >
                                    Sign In
                                </button>
                            </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-t from-black opacity-10 rounded-lg">
                ...
                <div className="mt-8 text-center">
                    <p className="mt-4 text-base text-gray-500">
                        All your file are encypted and stored securely with enterprise
                    </p>
                </div>
            </div>
        </div>
